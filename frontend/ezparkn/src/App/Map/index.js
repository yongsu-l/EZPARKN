  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        .map((parkingSpot, index) => {
                return (
                  <InfoWindow key={index} lat={parkingSpot.lat}  lng={parkingSpot.long} content={parkingSpot.user?parkingSpot.user.username:"Anonymous"} onCloseClick={this.onCloseClick} onClick={this.onClick}/> 
                )
            })}
